...
> **Re-seal provenance (SOL-126).** Transcribed verbatim from the first comment
> on SOL-112 (`[SOL-DOC] Four-hat review — 0003 provenance root`), per the
> SOL-107 re-seal pattern. No content added or altered.
